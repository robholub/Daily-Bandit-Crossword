...
// --- Massive Non-Repeating Word Dictionary ---
const DICT_DATA = [
  // Animals
  "DOG|Barking pet", "CAT|Meowing pet", "COW|Mooing farm animal", "PIG|Oinking farm animal", "HEN|Clucking bird", "FOX|Sly animal", "BEAR|Hibernating mammal", "LION|Jungle king", "TIGER|Striped cat", "WOLF|Howling canine", "DEER|Antlered animal", "FROG|Hopping amphibian", "TOAD|Warty amphibian", "SNAKE|Slithering reptile", "LIZARD|Scaly reptile", "FISH|Aquatic animal", "SHARK|Ocean predator", "WHALE|Massive marine mammal", "BIRD|Feathered flyer", "DUCK|Quacking bird", "SWAN|Graceful white bird", "HAWK|Sharp-eyed raptor", "EAGLE|Bald bird of prey", "OWL|Hooting bird", "BAT|Flying mammal", "RAT|City rodent", "MOUSE|Cheese lover", "ANT|Tiny worker insect", "BEE|Honey maker", "WASP|Stinging insect", "FLY|Buzzing bug", "MOTH|Nighttime flier", "WORM|Earth crawler", "SNAIL|Slow shelled crawler", "CRAB|Pinching crustacean", "SEAL|Barking marine mammal", "HORSE|Riding animal", "ZEBRA|Striped animal", "CAMEL|Desert animal", "MOOSE|Large antlered animal", "ELK|Large deer", "GOAT|Horned farm animal", "SHEEP|Woolly animal", "LAMB|Young sheep", "BULL|Male cow", "CALF|Baby cow", "PONY|Small horse", "MULE|Donkey-horse cross", "APE|Tailless primate", "MONKEY|Swinging primate", "CHIMP|Small ape", "GORILLA|Large ape", "PANDA|Bamboo eater", "KOALA|Black and white bear", "SLOTH|Eucalyptus eater", "OTTER|Water mammal", "BEAVER|Dam builder", "BADGER|Woodland creature", "SKUNK|Striped mammal", "RACCOON|Masked bandit", "POSSUM|Playing dead", "RABBIT|Carrot lover", "HARE|Fast rabbit", "MOLE|Underground digger", "VOLE|Blind digger", "MICE|Small rodents", "FLEA|Tiny jumping bug", "TICK|Dog pest", "GNAT|Annoying bug", "PEST|Nuisance bug", "SWARM|Group of bugs", "FLOCK|Group of birds", "HERD|Group of sheep", "PACK|Group of wolves", "PRIDE|Group of lions", "SCHOOL|Group of fish", "SHOAL|Group of fish", "FAWN|Baby deer", "CUB|Baby cow", "PUP|Baby dog", "FOAL|Baby horse", "MARE|Female horse", "STAG|Male deer", "BUCK|Male deer", "DOE|Female deer", "SOW|Female pig", "BOAR|Male pig",
  // Food & Drink
  "APPLE|Red fruit", "PEAR|Bell-shaped fruit", "PLUM|Purple fruit", "PEACH|Fuzzy fruit", "GRAPE|Vine fruit", "MELON|Large sweet fruit", "LEMON|Sour yellow fruit", "LIME|Sour green fruit", "KIWI|Fuzzy brown fruit", "FIG|Sweet seeded fruit", "DATE|Sweet desert fruit", "NUT|Hard-shelled seed", "SEED|Plant beginning", "BEAN|Legume", "PEA|Green pod seed", "CORN|Yellow cob veggie", "RICE|White grain", "OAT|Breakfast grain", "WHEAT|Flour grain", "BREAD|Baked dough", "CAKE|Birthday dessert", "PIE|Baked crust dessert", "TART|Small pie", "BUN|Round bread", "ROLL|Dinner bread", "MEAT|Protein source", "BEEF|Cow meat", "PORK|Pig meat", "HAM|Cured pork", "FISH|Seafood", "SOUP|Hot liquid meal", "STEW|Hearty hot meal", "MILK|Dairy drink", "CHEESE|Dairy block", "BUTTER|Dairy spread", "EGG|Breakfast oval", "OIL|Cooking liquid", "SALT|Savory seasoning", "PEPPER|Spicy seasoning", "SUGAR|Sweet crystals", "HONEY|Bee's syrup", "SYRUP|Pancake topping", "JAM|Fruit spread", "JELLY|Clear fruit spread", "WATER|H2O", "JUICE|Fruit drink", "SODA|Fizzy drink", "TEA|Brewed leaves", "BEER|Brewed beverage", "WINE|Fermented grapes", "MEAL|Breakfast, lunch, or dinner", "FOOD|Sustenance", "SNACK|Bite to eat", "BITE|Mouthful", "CHEW|Grind food", "SWALLOW|Ingest", "DIGEST|Process food", "COOK|Prepare food", "BAKE|Make bread", "BOIL|Heat water", "FRY|Cook in oil", "GRILL|Cook in pan", "ROAST|Cook over fire", "TOAST|Brown bread", "SLICE|Cut food", "CHOP|Cut into pieces", "DICE|Cut small", "MASH|Crush food", "PEEL|Remove skin", "POUR|Serve liquid", "STIR|Mix liquid", "WHISK|Beat quickly", "BLEND|Mix together", "TASTE|Sample food", "SPICE|Flavoring", "HERB|Plant flavoring", "MINT|Fresh herb", "BASIL|Green herb", "SAGE|Pizza herb", "THYME|Poultry herb", "CLOVE|Garlic segment", "ONION|Pungent bulb", "GARLIC|Vampire repellent", "LEEK|Onion relative", "CHIVE|Long green onion", "CARROT|Orange root", "POTATO|Starchy tuber", "YAM|Sweet potato", "BEET|Red root", "RADISH|Purple root", "TURNIP|Spicy root", "CELERY|Crunchy stalk", "CANDY|Sweet treat", "GUM|Chewy treat", "CHIP|Salty snack", "DIP|Snack sauce", "SAUCE|Liquid topping", "GRAVY|Meat sauce", "BROTH|Soup base", "ICING|Cake topping", "FROST|Cake topping", "GLAZE|Cake topping", "CREAM|Dairy topping", "CURD|Dairy product", "WHEY|Dairy product",
  // Tech & Science
  "REACT|Web framework", "APP|Mobile software", "CODE|Program text", "WEB|Internet", "HTML|Web structure", "CSS|Web styles", "NODE|JS runtime", "API|Data bridge", "DATA|Information", "USER|App client", "BUG|Code error", "TEST|Quality check", "BYTE|Eight bits", "BIT|Binary digit", "DISK|Storage drive", "FILE|Saved document", "CHIP|Silicon processor", "WIFI|Wireless net", "NET|Internet", "URL|Web address", "LINK|Hypertext", "SPAM|Junk mail", "VIRUS|Malware", "HACK|Breach security", "HOST|Server provider", "CLOUD|Remote servers", "PIXEL|Screen dot", "SCREEN|Display monitor", "MOUSE|Clicking device", "KEY|Board button", "FONT|Typeface", "ICON|Small symbol", "MENU|List of options", "TAB|Browser section", "PAGE|Web document", "SITE|Web location", "BOT|Automated script", "PING|Network check", "PORT|Network dock", "PATH|Directory route", "ROOT|Base directory", "UNIX|Classic OS", "LINUX|Open OS", "JAVA|Coding language", "MAC|Apple computer", "PC|Windows machine", "TECH|Technology", "MATH|Numbers subject", "ATOM|Basic particle", "LENS|Camera glass", "ZOOM|Camera function", "FOCUS|Bring into view", "FLASH|Camera light", "PRINT|Make hard copy", "SCAN|Digitize document", "COPY|Duplicate", "PASTE|Insert copy", "UNDO|Reverse action", "REDO|Remake action", "SAVE|Keep document", "LOAD|Open document", "EDIT|Modify document", "VIEW|See document", "HELP|Assistance", "FIND|Locate text", "REPLACE|Swap text", "QUIT|Exit program", "EXIT|Leave program", "BOOT|Start computer", "REBOOT|Restart computer", "LOGIN|Enter system", "LOGOUT|Exit system", "SYNC|Match data", "SEND|Transmit data", "RECV|Receive data", "MAIL|Electronic message", "POST|Online message", "CHAT|Online talk", "BLOG|Online journal", "VLOG|Video journal", "WIKI|Collaborative site", "FEED|Data stream", "TWEET|Short post", "LIKE|Upvote", "SHARE|Distribute post",
  // Geography & Buildings
  "CITY|Large urban area", "TOWN|Small settlement", "VILLAGE|Tiny settlement", "STATE|Nation subdivision", "COUNTRY|Nation", "NATION|Sovereign state", "CAPITAL|Seat of government", "PORT|Shipping dock", "ROAD|Paved street", "STREET|City road", "AVENUE|Wide street", "LANE|Narrow road", "HIGHWAY|Fast road", "BRIDGE|Overpass structure", "TUNNEL|Underground passage", "PARK|Recreation area", "SQUARE|City plaza", "YARD|House lawn", "GARDEN|Planted area", "FARM|Agricultural land", "BARN|Farm building", "HOUSE|Home building", "HOME|Place of residence", "BUILDING|Constructed structure", "TOWER|Tall structure", "WALL|Room divider", "ROOF|House top", "DOOR|Room entrance", "WINDOW|Wall glass", "FLOOR|Ground surface", "CEILING|Overhead surface", "ROOM|Enclosed space", "HALL|Corridor", "STAIR|Step up", "STEP|Single stair", "CHURCH|Place of worship", "TEMPLE|Place of worship", "SHRINE|Place of worship", "MOSQUE|Place of worship", "BANK|Money vault", "STORE|Place to buy things", "SHOP|Retail store", "MALL|Shopping center", "MARKET|Vendor gathering", "CAFE|Coffee shop", "PUB|Small bar", "BAR|Drinking establishment", "HOTEL|Place to stay", "MOTEL|Roadside hotel", "INN|Small hotel", "CAMP|Tent site", "TENT|Canvas shelter", "HUT|Small shelter", "CABIN|Wooden house", "SHACK|Rough cabin", "SHED|Tool building", "GARAGE|Car building", "PORCH|Outdoor deck", "DECK|Outdoor porch", "PATIO|Wooden deck", "SLUM|Poor area", "GHETTO|Poor area", "SUBURB|Residential area", "SLOPE|Incline", "RIDGE|Mountain edge", "CLIFF|Steep drop", "CRAG|Steep rock", "GORGE|Deep ravine", "CANYON|Deep gorge", "VALE|Valley", "GLEN|Valley", "DALE|Valley", "MOOR|Open land", "HEATH|Open land", "MARSH|Wetland", "SWAMP|Wetland", "BOG|Wetland", "FEN|Wetland",
  // Nature & Space
  "SUN|Our star", "MOON|Earth's satellite", "STAR|Night sky twinkler", "SKY|Blue expanse", "CLOUD|Fluffy sky object", "RAIN|Falling water", "SNOW|Winter flakes", "ICE|Frozen water", "FOG|Thick mist", "MIST|Light fog", "WIND|Moving air", "BREEZE|Gentle wind", "STORM|Severe weather", "THUNDER|Storm sound", "LIGHT|Illumination", "DARK|Absence of light", "DAY|24 hours", "NIGHT|Dark hours", "DAWN|Sunrise time", "DUSK|Sunset time", "MORNING|Early hours", "EVENING|Late hours", "NOON|Midday", "YEAR|365 days", "MONTH|Roughly 30 days", "WEEK|Seven days", "HOUR|60 minutes", "MINUTE|60 seconds", "SECOND|Tick of a clock", "TIME|Clock measurement", "DATE|Calendar day", "ERA|Historical period", "AGE|Years old", "PAST|Yesterday", "FUTURE|Tomorrow", "NOW|Present moment", "EARTH|Our home planet", "WORLD|The whole globe", "GLOBE|Sphere map", "MAP|Navigation paper", "NORTH|Compass point", "SOUTH|Opposite of north", "EAST|Sunrise direction", "WEST|Sunset direction", "MOUNTAIN|Tall rocky peak", "HILL|Small elevation", "VALLEY|Low area between hills", "PLAIN|Flat grassy land", "FIELD|Open meadow", "FOREST|Wooded area", "WOOD|Tree material", "TREE|Tall woody plant", "BUSH|Shrub", "GRASS|Lawn cover", "LEAF|Tree foliage", "STEM|Plant stalk", "ROOT|Underground plant part", "FLOWER|Blooming plant", "ROSE|Thorny red flower", "WEED|Unwanted plant", "DIRT|Soil", "SOIL|Earth for planting", "ROCK|Hard stone", "STONE|Small rock", "SAND|Beach dirt", "DUST|Tiny dirt particles", "MUD|Wet dirt", "CLAY|Modeling earth", "OCEAN|Vast body of water", "SEA|Salty water", "LAKE|Body of fresh water", "POND|Small body of water", "RIVER|Flowing waterway", "STREAM|Small river", "CREEK|Tiny river", "BEACH|Sandy shore", "COAST|Ocean edge", "SHORE|Water's edge", "ISLAND|Land surrounded by water", "BAY|Coastal inlet", "GULF|Large bay", "COVE|Small bay", "CAPE|Coastal headland", "CAVE|Underground chamber", "MINE|Underground pit", "HOLE|Empty space", "PIT|Deep hole", "DITCH|Trench", "TRENCH|Long ditch", "CANAL|Waterway", "ORBIT|Planetary path", "COMET|Icy space rock", "METEOR|Shooting star", "NOVA|Exploding star", "VOID|Empty space", "DUST|Cosmic particles",
  // Action Verbs
  "RUN|Move quickly", "WALK|Stroll", "JUMP|Leap in the air", "LEAP|Big jump", "HOP|Small jump", "SKIP|Light jump", "FALL|Drop down", "DROP|Let fall", "STAND|Be upright", "SIT|Rest on a chair", "LIE|Rest horizontally", "SLEEP|Rest in bed", "WAKE|Stop sleeping", "DREAM|Sleep vision", "THINK|Use your brain", "KNOW|Have knowledge", "LEARN|Acquire knowledge", "READ|View words", "WRITE|Create words", "SPEAK|Talk", "TALK|Speak", "TELL|Inform", "ASK|Question", "ANSWER|Reply", "LISTEN|Hear intently", "HEAR|Detect sound", "LOOK|Direct your eyes", "SEE|Detect light", "WATCH|Observe", "SHOW|Display", "HIDE|Conceal", "FIND|Locate", "LOSE|Misplace", "KEEP|Retain", "GIVE|Donate", "TAKE|Acquire", "GET|Obtain", "MAKE|Create", "BUILD|Construct", "BREAK|Shatter", "FIX|Repair", "CUT|Slice", "TEAR|Rip", "PULL|Draw towards", "PUSH|Shove away", "THROW|Toss", "CATCH|Grab in air", "HOLD|Grasp", "CARRY|Transport", "LOVE|Deep affection", "HATE|Deep dislike", "LIKE|Enjoy", "CARE|Look after", "WANT|Desire", "NEED|Require", "HOPE|Wish", "FEAR|Be afraid", "SCARE|Frighten", "SURPRISE|Startle", "LAUGH|Chuckle", "SMILE|Happy expression", "CRY|Shed tears", "WEEP|Cry heavily", "SHOUT|Yell", "YELL|Shout", "SING|Make musical sounds", "DANCE|Rhythmic movement", "PLAY|Engage in a game", "WORK|Do a job", "REST|Relax", "WAIT|Pause", "STOP|Halt", "GO|Proceed", "START|Begin", "END|Finish", "WIN|Be victorious", "LOSE|Be defeated", "BEAT|Defeat", "FIGHT|Brawl", "HELP|Assist", "SAVE|Rescue", "LEAD|Guide", "FOLLOW|Go after", "JOIN|Unite", "MEET|Encounter", "VISIT|Go to see", "LEAVE|Depart", "STAY|Remain", "LIVE|Be alive", "DIE|Cease living", "KILL|End life", "HURT|Cause pain", "HEAL|Cure pain", "CURE|Make well", "SICK|Ill", "ILL|Sick", "WELL|Healthy", "SWIM|Move in water", "DIVE|Plunge into water", "FLOAT|Stay on top", "SINK|Go down", "SOAR|Fly high", "GLIDE|Fly smoothly", "SLIDE|Move smoothly", "SLIP|Lose footing", "TRIP|Stumble", "FALL|Tumble", "CLIMB|Go up", "CRAWL|Move on hands and knees", "CREEP|Move slowly", "SNEAK|Move quietly", "HIDE|Keep out of sight", "SEEK|Look for", "HUNT|Search for prey", "FISH|Catch seafood", "TRAP|Catch prey", "SNARE|Catch prey", "BAIT|Lure prey",
  // Adjectives & Abstract
  "GOOD|Not bad", "BAD|Not good", "RIGHT|Correct or direction", "WRONG|Incorrect", "TRUE|Factual", "FALSE|Not true", "REAL|Actual", "FAKE|Not real", "SURE|Certain", "RICH|Wealthy", "POOR|Lacking wealth", "CHEAP|Inexpensive", "DEAR|Expensive or beloved", "FREE|Without cost", "OPEN|Not closed", "CLOSE|Shut", "FULL|Not empty", "EMPTY|Not full", "NEW|Fresh", "OLD|Aged", "YOUNG|Youthful", "FRESH|Recently made", "CLEAN|Not dirty", "DIRTY|Unclean", "SAFE|Secure", "WILD|Untamed", "CALM|Peaceful", "LOUD|Noisy", "QUIET|Silent", "BRAVE|Courageous", "SMART|Intelligent", "WISE|Knowing", "FOOL|Silly person", "CRAZY|Insane", "FUNNY|Humorous", "SAD|Unhappy", "HAPPY|Joyful", "MAD|Angry", "GLAD|Pleased", "BUSY|Occupied", "LAZY|Not busy", "PROUD|Feeling honor", "SHY|Timid", "BOLD|Fearless", "MEEK|Timid", "KIND|Nice", "MEAN|Not nice", "CRUEL|Mean", "NICE|Pleasant", "FAIR|Just", "JUST|Fair", "EQUAL|Same", "SAME|Identical", "DIFFERENT|Not the same", "ALIKE|Similar", "SIMILAR|Like", "OTHER|Alternative", "SOME|A few", "MANY|A lot", "FEW|Not many", "ALL|Every one", "NONE|Zero", "EACH|Every one", "EVERY|All", "ANY|Whichever", "FAST|Quick", "SLOW|Leisurely pace", "QUICK|Fast", "RAPID|Very fast", "HARD|Not soft", "SOFT|Not hard", "FIRM|Solid", "HEAVY|Weighs a lot", "LIGHT|Not heavy", "STRONG|Powerful", "WEAK|Not strong", "BIG|Large", "LARGE|Big", "HUGE|Very big", "SMALL|Not big", "TINY|Very small", "LONG|Not short", "SHORT|Not long", "TALL|High in stature", "HIGH|Elevated", "LOW|Near the bottom", "WIDE|Broad", "BROAD|Wide", "NARROW|Not wide", "THICK|Not thin", "THIN|Not thick", "FAT|Overweight", "SLIM|Slender", "ROUND|Circular", "FLAT|Level", "SHARP|Pointy", "DULL|Not sharp", "SMOOTH|Not rough", "ROUGH|Not smooth", "RED|Stop sign color", "BLUE|Sky color", "GREEN|Grass color", "YELLOW|Sun color", "BLACK|Night color", "WHITE|Snow color", "GRAY|Cloud color", "BROWN|Dirt color", "PINK|Cotton candy color", "GOLD|Precious yellow metal", "SILVER|Precious grey metal", "IRON|Strong building metal", "STEEL|Refined iron", "COPPER|Penny metal", "LEAD|Heavy metal", "BRASS|Yellow alloy", "BRONZE|Brown alloy", "TIN|Light metal", "ZINC|Soft metal", "WOOD|Tree material", "GLASS|Transparent material", "PLASTIC|Synthetic material", "PAPER|Writing material", "BONE|Skeleton part", "STONE|Hard earth", "BRICK|Building block", "SAND|Beach material", "CLAY|Modeling earth", "MUD|Wet dirt", "DIRT|Soil", "SOIL|Earth",
  // General Nouns & Items
  "CHAIR|Seat with a back", "SEAT|Place to sit", "SOFA|Living room seat", "COUCH|Living room seat", "BED|Sleeping furniture", "DESK|Office table", "TABLE|Dining surface", "SHELF|Book holder", "CABINET|Storage cupboard", "CLOSET|Wardrobe area", "RUG|Floor covering", "MAT|Small rug", "LAMP|Light source", "BULB|Light source inside a lamp", "CLOCK|Time teller", "WATCH|Wrist timepiece", "MIRROR|Reflective glass", "FRAME|Picture border", "PHOTO|Captured image", "PICTURE|Drawn or taken image", "ART|Creative expression", "PAINT|Wall color liquid", "BRUSH|Painting tool", "PEN|Ink writer", "PENCIL|Graphite writer", "PAPER|Writing surface", "BOOK|Reading material", "PAGE|Book leaf", "WORD|Text unit", "LETTER|Alphabet character", "NOTE|Short message", "MAIL|Postal delivery", "STAMP|Postage sticker", "CARD|Greeting paper", "BOX|Cardboard container", "BAG|Carrying sack", "PACK|Backpack", "CASE|Protective container", "SHIRT|Torso clothing", "PANTS|Leg clothing", "JEANS|Denim pants", "SHORT|Not long", "SKIRT|Lower body garment", "DRESS|One-piece garment", "SUIT|Formal menswear", "COAT|Winter jacket", "JACKET|Light coat", "SWEATER|Knit pullover", "SOCK|Foot warmer", "SHOE|Footwear", "BOOT|Heavy footwear", "HEEL|Shoe back", "SOLE|Shoe bottom", "HAT|Headwear", "CAP|Baseball headwear", "GLOVE|Hand warmer", "SCARF|Neck warmer", "BELT|Waist cincher", "TIE|Neckwear", "RING|Finger jewelry", "CHAIN|Metal links", "CLOTH|Fabric", "SILK|Smooth fabric", "WOOL|Sheep fabric", "COTTON|Soft plant fabric", "THREAD|Sewing string", "STRING|Thin cord", "ROPE|Thick cord", "KNOT|Tied rope", "WIRE|Metal string", "CABLE|Thick wire", "PIPE|Water tube", "TUBE|Hollow cylinder", "HOSE|Flexible water tube", "PLUG|Electrical connector", "CORD|Electrical wire", "BATH|Washing tub", "SHOWER|Washing spray", "SINK|Washing basin", "SOAP|Cleaning bar", "TOWEL|Drying cloth", "COMB|Hair straightener", "RAZOR|Shaving tool", "MOP|Floor cleaner", "BROOM|Sweeping tool", "TRASH|Garbage", "BIN|Trash container", "POT|Cooking vessel", "PAN|Frying vessel", "BOWL|Soup container", "PLATE|Dinner dish", "CUP|Drinking container", "MUG|Coffee container", "GLASS|Drinking vessel", "FORK|Eating utensil", "SPOON|Eating utensil", "KNIFE|Cutting tool", "JAR|Glass container", "JUG|Large container", "CAN|Metal container", "TIN|Metal container", "LID|Container cover", "CAP|Bottle cover", "CORK|Bottle stopper", "TRAY|Flat dish", "DISH|Plate or bowl", "FORK|Eating prong", "WHIP|Lashing tool", "LACE|Shoe string",
  // People & Roles
  "BOY|Male child", "GIRL|Female child", "MAN|Adult male", "WOMAN|Adult female", "KID|Child", "BABY|Infant", "SON|Male child", "WIFE|Female spouse", "KING|Male monarch", "QUEEN|Female monarch", "LORD|Noble master", "LADY|Noble woman", "CHIEF|Leader", "BOSS|Manager", "CREW|Team", "TEAM|Group of players", "BAND|Musical group", "ARMY|Military force", "CLUB|Social group", "PARTY|Celebration", "GUEST|Invited person", "HOST|Party thrower", "FRIEND|Pal", "ENEMY|Foe", "HERO|Savior", "STAR|Famous person", "IDOL|Revered person", "FAN|Admirer", "SPORT|Athletic contest", "GAME|Interactive fun", "RACE|Speed contest", "TRACK|Racing path", "SCORE|Points total", "GOAL|Soccer objective", "POINT|Unit of score", "MARK|Grade or spot", "SIGN|Indicator", "RULE|Law", "LAW|Legal rule", "CRIME|Illegal act", "POLICE|Law enforcement", "JUDGE|Court official", "COURT|Legal arena", "PRISON|Jail", "CELL|Prison room", "GUARD|Protector", "COP|Police officer", "COPPER|Police officer", "THIEF|Stealer", "ROBBER|Thief", "PIRATE|Sea thief", "SPY|Secret agent", "AGENT|Spy", "NINJA|Shadow warrior", "KNIGHT|Armored warrior", "MONK|Religious man", "PRIEST|Religious leader", "NUN|Religious woman", "POPE|Catholic leader", "MAYOR|City leader", "COOK|Chef", "CHEF|Head cook", "BAKER|Bread maker", "NURSE|Medical helper", "DOC|Doctor", "VET|Animal doctor", "MAID|House cleaner", "BUTLER|House servant", "VALET|Head servant", "PAGE|Errand boy", "SQUIRE|Knight's helper", "DUKE|Noble rank", "EARL|Noble rank", "BARON|Noble rank", "COUNT|Noble rank", "MAYOR|City leader", "CHIEF|Tribe leader",
  // Assorted Extensions
  "ABLE|Capable", "ACID|Sour liquid", "ACRE|Land measure", "ACT|Perform", "ACTOR|Performer", "ADAPT|Adjust", "ADDED|Put together", "ADMIT|Confess", "ADULT|Grown up", "AFTER|Later", "AGAIN|Once more", "AGENT|Representative", "AGREE|Consent", "AHEAD|In front", "ALARM|Warning sound", "ALBUM|Record collection", "ALERT|Warning", "ALIEN|Extraterrestrial", "ALIKE|Similar", "ALIVE|Living", "ALLOW|Permit", "ALONE|By oneself", "ALOUD|Out loud", "ALTER|Change", "AMBER|Bronze color", "AMEND|Modify", "AMONG|In the middle of", "AMPLE|Plenty", "ANGEL|Heavenly being", "ANGER|Fury", "ANGLE|Corner", "ANGRY|Mad", "ANKLE|Foot joint", "ANNOY|Bother", "APART|Separated", "APPLE|Red fruit", "APPLY|Put into use", "ARENA|Stadium", "ARGUE|Disagree", "ARISE|Stand up", "ARMOR|Metal suit", "ARRAY|Arrangement", "ARROW|Bow ammo", "ASSET|Valuable item", "AUDIO|Sound", "AUDIT|Inspect", "AVOID|Evade", "AWAKE|Not asleep", "AWARD|Prize", "AWARE|Conscious", "AWFUL|Terrible", "BACON|Breakfast meat", "BADGE|Emblem", "BAKER|Bread maker", "BASIC|Fundamental", "BASIL|Green herb", "BASIN|Sink", "BASIS|Foundation", "BATCH|Group", "BEACH|Sandy shore", "BEARD|Facial hair", "BEAST|Wild animal", "BEGIN|Start", "BEING|Creature", "BELLY|Stomach", "BELOW|Under", "BENCH|Long seat", "BERRY|Small fruit", "BIRTH|Beginning of life", "BLACK|Dark color", "BLADE|Knife edge", "BLAME|Accuse", "BLANK|Empty", "BLAST|Sudden explosion", "BLEND|Mix", "BLIND|Unable to see", "BLOCK|Solid piece", "BLOOD|Red fluid", "BLOOM|Flower opening", "BLOWN|Exploded", "BOARD|Wood plank", "BOAST|Brag", "BONUS|Reward", "BOOTH|Small stall", "BOUND|Tied", "BRAIN|Thinking organ", "BRAKE|Stopping pedal", "BRAND|Company name", "BRAVE|Courageous", "BREAD|Baked dough", "BREAK|Shatter", "BRICK|Building block", "BRIDE|Woman marrying", "BRIEF|Short", "BRING|Fetch", "BROAD|Wide", "BROWN|Earth color", "BRUSH|Sweeping tool", "BUILD|Construct", "BUNCH|Group", "BUYER|Purchaser", "CABIN|Log house", "CABLE|Thick wire", "CACHE|Hidden store", "CANDY|Sweet treat", "CATCH|Grab", "CAUSE|Reason", "CHAIN|Metal links", "CHAIR|Seat", "CHAMP|Winner", "CHANT|Rhythmic singing", "CHAOS|Confusion", "CHARM|Magic spell", "CHART|Graph", "CHASE|Pursue", "CHEAP|Inexpensive", "CHEAT|Deceive", "CHECK|Verify", "CHEEK|Side of face", "CHEER|Applaud", "CHESS|Board game", "CHEST|Torso", "CHIEF|Leader", "CHILD|Kid", "CHILL|Cool down", "CHOIR|Singing group", "CHOKE|Gag", "CHUCK|Throw", "CHUMP|Fool", "CHUNK|Piece", "CHURN|Stir", "CHUTE|Tube", "CIDER|Apple drink", "CIGAR|Tobacco roll", "CIVIL|Polite", "CLAIM|Demand", "CLAMP|Grip", "CLASH|Conflict", "CLASP|Grip", "CLASS|School group", "CLAW|Crab pincer", "CLEAN|Not dirty", "CLEAR|Transparent", "CLERK|Office worker", "CLICK|Mouse action", "CLIFF|Steep drop", "CLIMB|Ascend", "CLOAK|Cape", "CLOCK|Timepiece", "CLONE|Copy", "CLOSE|Near", "CLOTH|Fabric", "CLOUD|White sky puff", "CLOUT|Influence", "CLOWN|Jester", "CLUB|Group", "CLUE|Hint", "COACH|Trainer", "COAST|Shore", "COCOA|Chocolate", "COLON|Punctuation mark", "COLOR|Hue", "COMIC|Funny", "COMMA|Punctuation mark", "CORAL|Reef material", "COUCH|Sofa", "COUGH|Gag", "COULD|Might", "COUNT|Calculate", "COURT|Legal arena", "COVER|Hide", "CRACK|Break", "CRAFT|Create", "CRAMP|Spasm", "CRANE|Bird or machine", "CRASH|Collide", "CRATE|Box", "CRAWL|Creep", "CRAZY|Insane", "CREAM|Dairy", "CREDIT|Loan", "CREEK|Small river", "CREEP|Crawl", "CREPE|Thin pancake", "CREPT|Crawled", "CREST|Ridge", "CREW|Team", "CRIED|Wept", "CRIME|Illegal act", "CRISP|Crunchy", "CROSS|Intersect", "CROWD|Mob", "CROWN|King's hat", "CRUDE|Raw", "CRUEL|Mean", "CRUMB|Small piece", "CRUSH|Smash", "CRUST|Bread edge", "CURVE|Bend", "CYCLE|Bike", "DANCE|Move to music", "DELAY|Postpone", "DEPTH|Deepness", "DEVIL|Demon", "DOUBT|Uncertainty", "DRAFT|Sketch", "DRAMA|Play", "DREAM|Sleep vision", "DRESS|Clothing", "DRILL|Tool", "DRINK|Beverage", "DRIVE|Steer", "DRONE|Robot", "DROWN|Sink", "DRUNK|Intoxicated", "EAGER|Enthusiastic", "EARLY|Before time", "EARTH|Planet", "EIGHT|Number", "ELBOW|Arm joint", "EMPTY|Void", "ENEMY|Foe", "ENJOY|Like", "ENTER|Go in", "EQUAL|Same", "ERROR|Mistake", "EVENT|Occurrence", "EVERY|All", "EXACT|Precise", "EXIST|Be", "EXTRA|More", "FAINT|Weak", "FAIRY|Magical creature", "FAITH|Belief", "FALSE|Not true", "FANCY|Elegant", "FAULT|Mistake", "FAVOR|Good deed", "FEAST|Big meal", "FENCE|Boundary", "FETCH|Bring", "FEVER|Illness", "FIELD|Meadow", "FIGHT|Battle", "FINAL|Last", "FIRST|Initial", "FLAME|Fire", "FLASH|Light", "FLEET|Group of ships", "FLESH|Skin", "FLIGHT|Journey by air", "FLINT|Spark rock", "FLOAT|Hover", "FLOCK|Group of birds", "FLOOD|Water overflow", "FLOOR|Ground", "FLORA|Plants", "FLOUR|Baking powder", "FLUID|Liquid", "FLUTE|Instrument", "FLYER|Pamphlet", "FOCUS|Concentrate", "FORCE|Power", "FORGE|Create", "FORGIVE|Pardon", "FORTY|Number", "FOUND|Discovered", "FRAME|Border", "FRAUD|Fake", "FRESH|New", "FRONT|Fore", "FROST|Ice", "FROWN|Sad face", "FRUIT|Apple or pear", "FULLY|Completely", "FUNNY|Amusing", "GHOST|Spirit", "GIANT|Huge", "GLASS|Cup", "GLOBE|World", "GLORY|Honor", "GLOVE|Hand covering", "GRACE|Honor", "GRAND|Magnificent", "GRANT|Give", "GRASP|Hold", "GRASS|Lawn", "GREAT|Excellent", "GREEN|Color", "GREET|Welcome", "GRIEF|Sorrow", "GRILL|Cook", "GRIND|Crush", "GRIP|Hold", "GROAN|Moan", "GROSS|Disgusting", "GROUP|Collection", "GROVE|Small woods", "GROWN|Matured", "GUARD|Protect", "GUESS|Estimate", "GUEST|Visitor", "GUIDE|Lead", "GUILT|Blame", "HABIT|Routine", "HAPPY|Joyful", "HARSH|Cruel", "HASTE|Hurry", "HEART|Organ", "HEAVY|Weighty", "HELLO|Greeting", "HONEY|Sweet", "HORSE|Animal", "HOTEL|Inn", "HOUSE|Home", "HUMAN|Person", "HURRY|Rush", "IDEAL|Perfect", "IMAGE|Picture", "INDEX|List", "INNER|Inside", "INPUT|Data", "ISSUE|Problem", "JOINT|Connection", "JUDGE|Decide", "JUICE|Drink", "KNIFE|Blade", "KNOCK|Tap", "KNOW|Understand", "LABEL|Tag", "LABOR|Work", "LARGE|Big", "LASER|Beam", "LATER|After", "LAUGH|Chuckle", "LAYER|Tier", "LEARN|Study", "LEAVE|Depart", "LEGAL|Lawful", "LEMON|Citrus", "LEVEL|Flat", "LIGHT|Bright", "LIMIT|Boundary", "LIVER|Organ", "LOCAL|Nearby", "LOGIC|Reason", "LOOSE|Not tight", "LUCKY|Fortunate", "LUNCH|Meal", "MAGIC|Spells", "MAJOR|Important", "MAKER|Creator", "MARCH|Walk", "MATCH|Pair", "MAYOR|Leader", "MEANT|Intended", "MEDIA|News", "METAL|Iron", "METER|Measure", "MINOR|Small", "MODEL|Design", "MONEY|Cash", "MONTH|Time", "MORAL|Ethical", "MOTOR|Engine", "MOUNT|Climb", "MOUSE|Rodent", "MOUTH|Lips", "MOVIE|Film", "MUSIC|Tunes", "NEEDS|Requires", "NEVER|Not ever", "NIGHT|Dark", "NOISE|Sound", "NORTH|Direction", "NOVEL|Book", "NURSE|Caregiver", "OCCUR|Happen", "OCEAN|Sea", "OFFER|Give", "OFTEN|Frequently", "ORDER|Command", "OTHER|Different", "OUGHT|Should", "OUNCE|Weight", "OUTER|Outside", "OWNER|Possessor", "PAINT|Color", "PANEL|Board", "PAPER|Sheet", "PARTY|Celebration", "PEACE|Calm", "PHASE|Stage", "PHONE|Call", "PHOTO|Picture", "PIECE|Part", "PILOT|Flyer", "PITCH|Throw", "PLACE|Location", "PLAIN|Simple", "PLANT|Flora", "PLATE|Dish", "POINT|Dot", "POUND|Weight", "POWER|Force", "PRESS|Push", "PRICE|Cost", "PRIDE|Honor", "PRIME|Main", "PRINT|Copy", "PRIZE|Award", "PROOF|Evidence", "PROUD|Arrogant", "PROVE|Verify", "QUEEN|Monarch", "QUICK|Fast", "QUIET|Silent", "QUITE|Very", "RADIO|Broadcast", "RAISE|Lift", "RANGE|Scope", "RAPID|Fast", "RATIO|Proportion", "REACH|Extend", "REACT|Respond", "READY|Prepared", "REFER|Allude", "RIGHT|Correct", "RIVAL|Opponent", "RIVER|Stream", "ROMAN|Ancient", "ROUGH|Uneven", "ROUND|Circular", "ROUTE|Path", "ROYAL|Regal", "RURAL|Country", "SCALE|Measure", "SCENE|Setting", "SCOPE|Range", "SCORE|Points", "SENSE|Feel", "SERVE|Assist", "SEVEN|Number", "SHALL|Must", "SHAPE|Form", "SHARE|Divide", "SHARP|Keen", "SHEET|Page", "SHIFT|Move", "SHIRT|Clothing", "SHOCK|Surprise", "SHOOT|Fire", "SHORT|Brief", "SHOUT|Yell", "SIGHT|Vision", "SKILL|Ability", "SLEEP|Rest", "SLICE|Cut", "SMALL|Tiny", "SMART|Clever", "SMILE|Grin", "SMITH|Worker", "SMOKE|Fumes", "SOLID|Firm", "SOLVE|Figure out", "SORRY|Apologetic", "SOUND|Noise", "SOUTH|Direction", "SPACE|Area", "SPARE|Extra", "SPEAK|Talk", "SPEED|Velocity", "SPELL|Magic", "SPEND|Pay", "SPILL|Drop", "SPITE|Malice", "SPLIT|Divide", "SPORT|Game", "SQUAD|Team", "STAFF|Team", "STAGE|Phase", "STAND|Rise", "START|Begin", "STATE|Condition", "STEAM|Vapor", "STEEL|Metal", "STICK|Adhere", "STILL|Quiet", "STOCK|Supply", "STONE|Rock", "STORE|Shop", "STORY|Tale", "STUDY|Learn", "STUFF|Items", "STYLE|Fashion", "SUGAR|Sweet", "SUPER|Great", "SWEET|Sugary", "TABLE|Desk", "TASTE|Flavor", "TEACH|Educate", "TEETH|Bones", "TEXAS|State", "THANK|Gratitude", "THEFT|Robbery", "THEIR|Them", "THEME|Topic", "THERE|Here", "THESE|Those", "THICK|Dense", "THIEF|Robber", "THING|Item", "THINK|Ponder", "THIRD|Number", "THOSE|These", "THREE|Number", "THROW|Toss", "TIGHT|Firm", "TITLE|Name", "TODAY|Now", "TOKEN|Symbol", "TOTAL|Sum", "TOUCH|Feel", "TOWER|Building", "TRACK|Path", "TRADE|Exchange", "TRAIN|Locomotive", "TREAT|Cure", "TREND|Fad", "TRIAL|Test", "TRIBE|Group", "TRICK|Cheat", "TROOP|Group", "TRUCK|Vehicle", "TRULY|Really", "TRUST|Faith", "TRUTH|Fact", "TUMOR|Growth", "TWICE|Double", "UNCLE|Relative", "UNDER|Below", "UNION|Alliance", "UNTIL|Up to", "UPPER|Higher", "UPSET|Sad", "URBAN|City", "USUAL|Normal", "VALID|Legal", "VALUE|Worth", "VIDEO|Film", "VIRUS|Germ", "VISIT|Tour", "VITAL|Crucial", "VOICE|Speech", "WASTE|Garbage", "WATCH|Look", "WATER|Drink", "WHEEL|Tire", "WHERE|Location", "WHICH|What", "WHILE|During", "WHITE|Color", "WHOLE|Entire", "WHOSE|Who", "WOMAN|Lady", "WORLD|Earth", "WORRY|Fret", "WORSE|Bad", "WORST|Terrible", "WORTH|Value", "WOULD|Could", "WOUND|Injury", "WRITE|Pen", "WRONG|Incorrect", "YIELD|Give way", "YOUNG|Youthful", "YOUTH|Youngster"
];
